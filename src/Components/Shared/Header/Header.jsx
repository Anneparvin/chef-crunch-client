      ...
      <div>
            ...
            <div className="navbar-start">
                ...
                <Link to="/" className="btn btn-ghost normal-case text-xl">
                    <img className='w-16 h-16 rounded-lg' src={logo1} alt="" />
                </Link>
                <p className='text-2xl font-bold flex'><span className='text-green-400 text-4xl font-bold'>Chef</span><span className='text-amber-400 font-bold text-5xl'>Krunch</span> </p>
            </div>
